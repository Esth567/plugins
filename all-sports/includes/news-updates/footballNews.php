...
function basketball_news_shortcode() {
    ob_start();
    ?>
    <div id="wg-api-footballnews-games"></div>
    <script>
    const url = 'https://soccer-news-player-profiles-api.p.rapidapi.com/news';
    const options = {
        method: 'GET',
        headers: {
    ...
    function displayBasketballNews(newsData) {
        const newsContainer = document.getElementById('wg-api-footballnews-games');
